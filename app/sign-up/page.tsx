      ...
      <div className="w-full max-w-md glass-premium rounded-3xl p-8 sm:p-10 relative z-10 shadow-2xl shadow-emerald-950/20 border border-white/5">
            ...
            <form onSubmit={handleSignUp} className="space-y-4">
              <div>
                ...
                <input
                  ...
                  className="w-full px-4 py-3 bg-black/40 border border-white/10 hover:border-white/20 focus:border-brand-primary rounded-xl text-white text-sm focus:outline-none transition"
                />
              </div>
        ...
        <div className="mt-8 pt-6 border-t border-white/5 text-center text-xs text-slate-400 flex flex-col space-y-2.5">
          <span>
            ...
            <Link href="/sign-in" className="text-brand-accent hover:text-brand-secondary font-semibold transition">
              Sign In
            </Link>
          </span>

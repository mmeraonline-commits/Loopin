    ...
    <div className="space-y-6 max-w-6xl">
      <div className="flex flex-col sm:flex-row sm:items-end justify-between gap-4">
        ...
        <input
          ...
          className="w-full sm:w-72 rounded-xl border border-slate-200 dark:border-white/10 bg-white dark:bg-[#0d111e] px-3 py-2 text-sm outline-none focus:ring-2 focus:ring-brand-primary/40"
        />
      </div>

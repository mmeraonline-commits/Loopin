...
const secrets = {
  ...
  MICROSOFT_CLIENT_ID: env.MICROSOFT_CLIENT_ID || env.OUTLOOK_CLIENT_ID,
  MICROSOFT_CLIENT_SECRET: env.MICROSOFT_CLIENT_SECRET || env.OUTLOOK_CLIENT_SECRET,
  ...
  RESEND_FROM: env.RESEND_FROM || env.RESEND_FROM_EMAIL,
  NEXT_PUBLIC_VAPID_PUBLIC_KEY: env.NEXT_PUBLIC_VAPID_PUBLIC_KEY,
  VAPID_PRIVATE_KEY: env.VAPID_PRIVATE_KEY,
  VAPID_SUBJECT: env.VAPID_SUBJECT || "mailto:maccidomuhammad1313@gmail.com",
